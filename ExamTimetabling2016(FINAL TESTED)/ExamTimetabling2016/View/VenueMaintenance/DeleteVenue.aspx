<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DeleteVenue.aspx.cs" Inherits="FYP.Venue_Maintenance.DeleteVenue" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

        <h1>Delete Exam Venue</h1>
    <hr />
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <asp:DropDownList ID="dd_block" runat="server" DataSourceID="SqlDataSource1" DataTextField="BlockCode" DataValueField="BlockCode" AutoPostBack="True" OnSelectedIndexChanged="dd_block_SelectedIndexChanged" CssClass="form-control" Width="76%"></asp:DropDownList>
