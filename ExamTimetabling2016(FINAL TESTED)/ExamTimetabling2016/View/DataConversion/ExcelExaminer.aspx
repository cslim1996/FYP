<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ExcelExaminer.aspx.cs" Inherits="ExamTimetabling2016.View.ExcelExaminer" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript" src="../../Scripts/script.js"></script>
    <div id="parentExcel">
        <div class="leftExcel">
            <h2>Data Import for Examiner</h2>
            <table style="width: 30%" border="1">
                ...
                <tr>
                    <td>
                        <asp:RadioButtonList ID="rListFaculty" runat="server">
