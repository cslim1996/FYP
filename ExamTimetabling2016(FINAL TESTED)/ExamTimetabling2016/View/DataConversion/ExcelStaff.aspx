<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ExcelStaff.aspx.cs" Inherits="ExamTimetabling2016.View.ExcelStaff" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript" src="../../Scripts/script.js"></script>
    <div id="parentExcel">
        <div class="leftExcel">
            <h2>Data Import for Staff</h2>
            <table border="1">
                <tr>
                    <td><b>Faculty</b></td>
                    <td><b>Level</b></td>
                ...
                <tr>
                    <td>
                        <asp:RadioButtonList ID="rListExaminer" runat="server" AutoPostBack="True" OnSelectedIndexChanged="rListExaminer_SelectedIndexChanged">
