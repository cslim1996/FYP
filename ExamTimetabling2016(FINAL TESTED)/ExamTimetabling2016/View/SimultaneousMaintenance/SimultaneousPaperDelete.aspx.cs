...
{
    public partial class SimultaneousPaperDelete : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (PreviousPage != null)
            {
                ...
                if (SCIDLabel != null)
                {
                    txtID.Text = SCIDLabel.Text;
                    txtFaculty.Text = facultyLabel.Text;
                    txtSCList.Text = SCList.Text.Replace("|", "\n");
                }
            }
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            strUpdate = "Update SimultaneousCourses Set Status = @Status Where SCID = @SCID";

            cmdUpdate = new SqlCommand(strUpdate, conn);

            cmdUpdate.Parameters.AddWithValue("@Status", "Deleted");
            cmdUpdate.Parameters.AddWithValue("@SCID", int.Parse(txtID.Text));
            ...
            else
            {
                ...
                Panel1.Visible = false;
                Panel2.Visible = true;
                lblDeleteStatus.Text = "Sorry, delete failed.";
            }
