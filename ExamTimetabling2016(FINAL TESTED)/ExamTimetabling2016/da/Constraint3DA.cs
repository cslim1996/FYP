    ...
    public class Constraint3DA
    {
        ...
        public void deleteConstraint(int id)
        {
            ...
            try
            {
                ...
                strSearch = "delete from dbo.constraints where constraintid = @id";
